...
- June 24, 2025. COMPLETED: Password reset system enhanced with 24-hour token validity - updated system to store multiple reset tokens per user (comma-separated), extended expiry to 24 hours, all previously issued tokens remain valid until expiry. Users can now use any reset code sent within 24 hours for maximum flexibility.
